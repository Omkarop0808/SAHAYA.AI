  ...
  return (
    <div className="space-y-4">
      ...
      <div className="career-card">
        ...
        <div className="text-sm text-white/65 mt-1">Days active and completion activity are tracked automatically.</div>
      </div>
      ...
      <div className="career-card">
        ...
        {today?.etaWeeks ? <div className="text-xs text-white/60 mt-2">Estimated time remaining: {today.etaWeeks} weeks</div> : null}
      </div>
    </div>
  );
}
